...
func TestMarinerVulnSrc_Update(t *testing.T) {
	tests := []struct {
		name       string
		dir        string
	...
	tests := []struct {
	...
	}{
		{
			...
			wantValues: []vulnsrctest.WantValues{
				...
				{
					Key: []string{"vulnerability-detail", "CVE-2023-27534", "azure"},
					Value: types.VulnerabilityDetail{
						Severity:    types.SeverityHigh,
				...
				{
					Key: []string{"vulnerability-detail", "CVE-2018-1999023", "azure"},
					Value: types.VulnerabilityDetail{
						Severity:    types.SeverityHigh,
				...
				{
					Key:   []string{"vulnerability-id", "CVE-2023-27534"},
					Value: map[string]interface{}{},
				},
				{
					Key:   []string{"vulnerability-id", "CVE-2018-1999023"},
					Value: map[string]interface{}{},
				},
			},
		},
...
func TestMarinerVulnSrc_Get(t *testing.T) {
	tests := []struct {
		name     string
		release  string
		pkgName  string
