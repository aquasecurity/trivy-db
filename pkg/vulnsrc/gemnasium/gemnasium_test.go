...
func TestVulnSrc_Update(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantErr: "error in Gemnasium save",
		},
	}
...
func TestVulnSrc_save(t *testing.T) {
	...
	tests := []struct {
			...
			putVulnerabilityDetail: []db.OperationPutVulnerabilityDetailExpectation{
				{
					Args: db.OperationPutVulnerabilityDetailArgs{
						TxAnything:      true,
						Source:          vulnerability.GemnasiumConan,
						VulnerabilityID: "CVE-2020-14150",
			...
			putVulnerabilityDetail: []db.OperationPutVulnerabilityDetailExpectation{
				{
					Args: db.OperationPutVulnerabilityDetailArgs{
						TxAnything:      true,
						Source:          vulnerability.GemnasiumGem,
						VulnerabilityID: "OSVDB-112347",
						Vulnerability: types.VulnerabilityDetail{
							ID:       "OSVDB-112347",
							Severity: types.SeverityUnknown,
			...
			putVulnerabilityDetail: []db.OperationPutVulnerabilityDetailExpectation{
				{
					Args: db.OperationPutVulnerabilityDetailArgs{
						TxAnything:      true,
						Source:          vulnerability.GemnasiumGo,
						VulnerabilityID: "CVE-2016-1905",
						Vulnerability: types.VulnerabilityDetail{
							ID:       "CVE-2016-1905",
							Severity: types.SeverityUnknown,
			...
			putVulnerabilityDetail: []db.OperationPutVulnerabilityDetailExpectation{
				{
					Args: db.OperationPutVulnerabilityDetailArgs{
						TxAnything:      true,
						Source:          vulnerability.GemnasiumMaven,
						VulnerabilityID: "CVE-2018-1196",
						Vulnerability: types.VulnerabilityDetail{
							ID:       "CVE-2018-1196",
							Severity: types.SeverityUnknown,
			...
			putVulnerabilityDetail: []db.OperationPutVulnerabilityDetailExpectation{
				{
					Args: db.OperationPutVulnerabilityDetailArgs{
						TxAnything:      true,
						Source:          vulnerability.GemnasiumNpm,
						VulnerabilityID: "CVE-2019-10742",
						Vulnerability: types.VulnerabilityDetail{
							ID:       "CVE-2019-10742",
							Severity: types.SeverityUnknown,
			...
			putVulnerabilityDetail: []db.OperationPutVulnerabilityDetailExpectation{
				{
					Args: db.OperationPutVulnerabilityDetailArgs{
						TxAnything:      true,
						Source:          vulnerability.GemnasiumNuget,
						VulnerabilityID: "CVE-2020-1108",
						Vulnerability: types.VulnerabilityDetail{
							ID:       "CVE-2020-1108",
							Severity: types.SeverityUnknown,
			...
			putVulnerabilityDetail: []db.OperationPutVulnerabilityDetailExpectation{
				{
					Args: db.OperationPutVulnerabilityDetailArgs{
						TxAnything:      true,
						Source:          vulnerability.GemnasiumPackagist,
						VulnerabilityID: "GMS-2018-25",
						Vulnerability: types.VulnerabilityDetail{
							ID:       "GMS-2018-25",
							Severity: types.SeverityUnknown,
			...
			putVulnerabilityDetail: []db.OperationPutVulnerabilityDetailExpectation{
				{
					Args: db.OperationPutVulnerabilityDetailArgs{
						TxAnything:      true,
						Source:          vulnerability.GemnasiumPypi,
						VulnerabilityID: "CVE-2020-13254",
						Vulnerability: types.VulnerabilityDetail{
							ID:       "CVE-2020-13254",
							Severity: types.SeverityUnknown,
		...
		},
		{
			...
			wantErr: "failed to save Gemnasium vulnerability detail",
		},
		{
			...
			wantErr: "failed to save Gemnasium vulnerability severity",
		},
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			err := vs.commit(nil, tt.args.gemnasiums)
...
func TestVulnSrc_Get(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			packageType: Conan,
			args: args{
				release: "conan::Gemnasium Advisory Conan",
				pkgName: "bison",
			},
			forEachAdvisoryExpectation: db.OperationForEachAdvisoryExpectation{
				...
				Returns: db.OperationForEachAdvisoryReturns{
					Value: map[string][]byte{
						"CVE-2019-19745": []byte(`{"AffectedRange": "\u003c3.5.4", "PatchedVersions": ["3.7.1"]}`),
					},
				},
			},
			want: []Advisory{
		...
		},
		{
			...
			packageType: Gem,
			args: args{
				release: "rubygems::Gemnasium Advisory Gem",
				pkgName: "activejob",
			},
			forEachAdvisoryExpectation: db.OperationForEachAdvisoryExpectation{
				Args: db.OperationForEachAdvisoryArgs{
				...
				Returns: db.OperationForEachAdvisoryReturns{
					Value: map[string][]byte{
						"OSVDB-112347": []byte(`{"AffectedRange": "=4.2.0.beta1", "PatchedVersions": ["4.2.0.beta2"]}`),
					},
				},
			},
			want: []Advisory{
		...
		},
		{
			...
			packageType: Go,
			args: args{
				release: "go::Gemnasium Advisory Go",
				pkgName: "k8s.io/kubernetes",
			},
			forEachAdvisoryExpectation: db.OperationForEachAdvisoryExpectation{
				Args: db.OperationForEachAdvisoryArgs{
				...
				Returns: db.OperationForEachAdvisoryReturns{
					...
					Value: map[string][]byte{
						"CVE-2016-1905": []byte(`{"AffectedRange": "\u003cv1.2.0", "PatchedVersions": ["v1.2.0"]}`),
					},
				},
			},
			want: []Advisory{
		...
		},
		{
			...
			packageType: Maven,
			args: args{
				release: "maven::Gemnasium Advisory Maven",
				pkgName: "org.springframework.boot/spring-boot",
			},
			forEachAdvisoryExpectation: db.OperationForEachAdvisoryExpectation{
				Args: db.OperationForEachAdvisoryArgs{
				...
				Returns: db.OperationForEachAdvisoryReturns{
					Value: map[string][]byte{
						"CVE-2018-1196": []byte(`{"AffectedRange": "(,1.5.10)", "PatchedVersions": ["1.5.10.RELEASE"]}`),
					},
				},
			},
			want: []Advisory{
		...
		},
		{
			...
			packageType: Npm,
			args: args{
				release: "npm::Gemnasium Advisory Npm",
				pkgName: "axios",
			},
			forEachAdvisoryExpectation: db.OperationForEachAdvisoryExpectation{
				Args: db.OperationForEachAdvisoryArgs{
				...
				Returns: db.OperationForEachAdvisoryReturns{
					Value: map[string][]byte{
						"CVE-2019-10742": []byte(`{"AffectedRange": "\u003c=0.18.0", "PatchedVersions": ["0.18.1"]}`),
					},
				},
			},
			want: []Advisory{
		...
		},
		{
			...
			packageType: Nuget,
			args: args{
				release: "nuget::Gemnasium Advisory Nuget",
				pkgName: "powershell",
			},
			forEachAdvisoryExpectation: db.OperationForEachAdvisoryExpectation{
				Args: db.OperationForEachAdvisoryArgs{
				...
				Returns: db.OperationForEachAdvisoryReturns{
					Value: map[string][]byte{
						"CVE-2020-1108": []byte(`{"AffectedRange": "[7.0]", "PatchedVersions": ["7.1.0"]}`),
					},
				},
			},
			want: []Advisory{
		...
		},
		{
			...
			packageType: Packagist,
			args: args{
				release: "composer::Gemnasium Advisory Packagist",
				pkgName: "adodb/adodb-php",
			},
			forEachAdvisoryExpectation: db.OperationForEachAdvisoryExpectation{
				Args: db.OperationForEachAdvisoryArgs{
				...
				Returns: db.OperationForEachAdvisoryReturns{
					Value: map[string][]byte{
						"GMS-2018-25": []byte(`{"AffectedRange": "\u003c5.20.11", "PatchedVersions": ["v5.20.11"] }`),
					},
				},
			},
			want: []Advisory{
		...
		},
		{
			...
			packageType: Pypi,
			args: args{
				release: "pip::Gemnasium Advisory Pypi",
				pkgName: "Django",
			},
			forEachAdvisoryExpectation: db.OperationForEachAdvisoryExpectation{
				Args: db.OperationForEachAdvisoryArgs{
				...
				Returns: db.OperationForEachAdvisoryReturns{
					Value: map[string][]byte{
						"CVE-2020-13254": []byte(`{"AffectedRange": "\u003e=2.2,\u003c2.2.13||\u003e=3.0,\u003c3.0.7", "PatchedVersions": ["2.2.13", "3.0.7"]}`),
					},
				},
			},
			want: []Advisory{
		...
		},
		{
			...
			wantErr: "failed to iterate Gemnasium",
		},
	}
